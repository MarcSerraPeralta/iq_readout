...
"""
THIS IS WRONG BECAUSE IF IT IS QUADRATIC ANALYSIS, ONE CANNOT PROJECT THE DATA TO A SINGLE AXIS
"""
...
def simple_1d_gaussian_double_mixture(
    ...
    z = a1 * simple_1d_gaussian(x, mu=mu_1, sigma=sigma_1) + a2 * simple_1d_gaussian(
        x, mu=mu_2, sigma=sigma_2
    )
